...
public final class StructRegionPackets {
    ...
    public static class Request {
        ...
        public static void handle(Request msg, ServerPlayer sp) {
            if (!PermsStore.resolve(sp, "panoptic.seed.structures")) {
                return;
            }
            ...
            RegionScan.compute(level, msg.rx, msg.rz, found -> {
                ...
                if (target != null) {
                    Result.send(target, new Result(msg.dim, msg.rx, msg.rz, found));
                }
            });
        }
    }
