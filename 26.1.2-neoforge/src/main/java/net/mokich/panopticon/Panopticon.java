...
public class Panopticon {
    ...
    private void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        r.playToServer(TradeBookPackets.Request.TYPE, TradeBookPackets.Request.STREAM_CODEC, TradeBookPackets.Request::handle);
        r.playToClient(TradeBookPackets.Result.TYPE, TradeBookPackets.Result.STREAM_CODEC, TradeBookPackets.Result::handle);
